...
#include <linux/regulator/consumer.h> //jj_moidfy jannie add
...
void kernel_restart(char *cmd)
{
	...
	*/
	...
	//jj_modify beign by jannie shut down the power off 8189
	{
	struct regulator *ldo;
	ldo = regulator_get(NULL, "vaux2");	 //vcc_tp
	//regulator_set_voltage(ldo, 3300000, 3300000);
	regulator_disable(ldo);
	printk("%s disable vaux2  vcc_tp=%dmV end\n", __func__, regulator_get_voltage(ldo));
	regulator_put(ldo);
